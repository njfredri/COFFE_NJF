...
#top-level for the boothr2 adder (adder/subtractor with copy ability)
def generate_boothr2adder_top(name):
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("*--------------------------------------------------------------\n")
	top_file.write(".TITLE BoothR2 ALU Unit Testbench\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Include libraries, parameters, and device models\n")
	top_file.write("********************************************************************************\n")
	top_file.write(".LIB \"../includes.l\" INCLUDES\n\n")
	top_file.write("* .LIB \"./pim_B2Adder_coffe.sp\" PIM_B2_ALU\n")
	top_file.write("* .param supply_v=0.8V\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Simulation setup\n")
	top_file.write("********************************************************************************\n")
	top_file.write("* Run for 40 ns with 10 ps resolution\n")
	top_file.write(".TRAN 1p 6n SWEEP DATA=sweep_data\n")
	top_file.write(".OPTIONS BRIEF=1\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("********************************************************************************\n")
	top_file.write("* Clk: 50% duty cycle, 2 ns period (500 MHz)\n")
	top_file.write("* Vclk clk 0 PULSE(0 supply_v 0 50p 50p 1n 2n)\n")
	top_file.write("\n")
	top_file.write("* Control enables\n")
	top_file.write("* Vopop_bus0 0 PULSE(0 supply_v 2n 50p 50p 20n 40n)\n")
	top_file.write("* VopLoad opLoad 0 PULSE(0 supply_v 10n 50p 50p 10n 20n)\n")
	top_file.write("\n")
	top_file.write("* * Config bus values (could toggle or be static depending on test)\n")
	top_file.write("* VopConfig0 op0 0 PULSE(0 supply_v 0 50p 50p 10n 20n)\n")
	top_file.write("* VopConfig1 op1 0 PULSE(0 supply_v 0 50p 50p 20n 40n)\n")
	top_file.write("VopConfig0 op0 0 supply_v\n")
	top_file.write("VopConfig1 op1 0 supply_v\n")
	top_file.write("\n")
	top_file.write("* Vx x 0 PULSE(0 supply_v 2n 0 0 1n 4n)\n")
	top_file.write("Vx x 0 0\n")
	top_file.write("Vy y 0 supply_v\n")
	top_file.write("* Vcin cin 0 PULSE(0 supply_v 2n 0 0 7n 16n)\n")
	top_file.write("Vcin cin 0 PULSE(0 supply_v 1n 0 0 2n 4n)\n")
	top_file.write("\n")
	top_file.write("\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("********************************************************************************\n")
	top_file.write("Xb2ALU op0 op1 x y cin out cout n_vdd n_gnd BoothR2Adder\n")
	top_file.write("\n")
	#extra gates for timings
	top_file.write("Xb2ALU_INV cin inv_out n_vdd n_gnd inv ")
	top_file.write(" Wn=inv_BoothR2Adder_nmos Wp=inv_BoothR2Adder_pmos \n")
	top_file.write('Xb2ALU_NAND2 cin nand2_out n_vdd n_gnd nand2 ')
	top_file.write(" Wn=nand2_BoothR2Adder_nmos Wp=nand2_BoothR2Adder_pmos \n")
	top_file.write('Xb2ALU_NAND3 cin nand3_out n_vdd n_gnd nand3 ')
	top_file.write(" Wn=nand3_BoothR2Adder_nmos Wp=nand3_BoothR2Adder_pmos \n")
	top_file.write('Xb2ALU_NOR2 cin cin nor2_out n_vdd n_gnd nor2_decode ')
	top_file.write(" Wn=nor2_BoothR2Adder_nmos Wp=nor2_BoothR2Adder_pmos \n")
	#Measurements
	top_file.write("********************************************************************************\n")
	top_file.write("** Measurements\n")
	top_file.write("********************************************************************************\n")
	top_file.write("* Measure propagation delay: input y rising → output transition\n")
	top_file.write("\n")
	top_file.write("*Inverted measurements\n")
	top_file.write(".MEASURE TRAN meas_"+name+"_trise TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_"+name+"_tfall TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	top_file.write(".MEASURE TRAN meas_total_trise TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_total_tfall TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#Inverter timing
	top_file.write(".MEASURE TRAN meas_inv_boothr2adder_trise TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(inv_out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_inv_boothr2adder_tfall TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(inv_out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#nand2 timing
	top_file.write(".MEASURE TRAN meas_nand2_boothr2adder_trise TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(nand2_out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_nand2_boothr2adder_tfall TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(nand2_out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#nand3 timing
	top_file.write(".MEASURE TRAN meas_nand3_boothr2adder_trise TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(nand3_out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_nand3_boothr2adder_tfall TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(nand3_out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#nor2 timing
	top_file.write(".MEASURE TRAN meas_nor2_boothr2adder_trise TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(nor2_out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_nor2_boothr2adder_tfall TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(nor2_out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")

	#rest of measurements
	top_file.write("*cin measurements\n")
	top_file.write("\n")
	top_file.write("* Logic levels at output\n")
	# top_file.write(".MEASURE TRAN vout_low  FIND V(out) AT=2n\n")
	top_file.write(".MEASURE TRAN meas_logic_low_voltage  FIND V(out) AT=2n\n")
	# top_file.write(".MEASURE TRAN vout_high FIND V(out) AT=4n\n")
	top_file.write("\n")
	top_file.write("* Power consumption\n")
	top_file.write(".MEASURE TRAN i_vdd      INTEGRAL I(VDD) FROM=0n TO=6n\n")
	top_file.write(".MEASURE TRAN meas_avg_power  PARAM = '-(i_vdd/6n)*supply_v'\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("\n")
	top_file.write("* .print tran V(out) V(cout)\n")
	top_file.write("\n")
...
def generate_bob2adder_top(name):
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("********************************************************************************\n")
	top_file.write(".LIB \"../includes.l\" INCLUDES\n")
	top_file.write("* .LIB \"./Bobby_B2Adder.sp\" PIM_B2_ALU\n")
	top_file.write("* .param supply_v=0.8V\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Simulation setup\n")
	top_file.write("********************************************************************************\n")
	top_file.write("* Run for 40 ns with 10 ps resolution\n")
	top_file.write(".TRAN 10p 6n\n")
	top_file.write(".OPTIONS BRIEF=1\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Power supplies\n")
	...
	top_file.write("VopConfig1 op1 0 supply_v\n")
	top_file.write("\n")
	top_file.write("VopConfig0n op0_n 0 0 \n")
	top_file.write("VopConfig1n op1_n 0 0\n")
	top_file.write("\n")
	top_file.write("* Vx x 0 PULSE(0 supply_v 2n 0 0 1n 4n)\n")
	top_file.write("Vx x 0 0\n")
	top_file.write("Vy y 0 supply_v\n")
	...
	top_file.write("** Circuit under test\n")
	top_file.write("********************************************************************************\n")
	top_file.write("Xb2ALU op0 op1 op0_n op1_n x y cin out cout n_vdd n_gnd bob2_adder\n")
	top_file.write("* op0 op1 x y cin out cout n_vdd n_gnd\n")
	top_file.write("\n")
	top_file.write("*Inverted measurements\n")
	top_file.write(".MEASURE TRAN meas_total_trise TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_total_tfall TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	top_file.write("*cin measurements\n")
	...
	top_file.write("********************************************************************************\n")
	top_file.write("\n")
	top_file.write("* .print tran V(x) V(y) V(cin_2) V(sum) V(cout)\n")
	top_file.write("\n")
	top_file.write(".OPTION POST\n")
	top_file.write("\n")
	top_file.write(".END\n")
...
def generate_pim_opmux_top(name, num_pes:int):
	match num_pes:
		case 32:
			top_level_opmux.gen_top_pim_opmux_32(name)
			os.chdir("../")
			return (name + "/" + name + ".sp")
		case 64:
			top_level_opmux.gen_top_pim_opmux_64(name)
			os.chdir("../")
			return (name + "/" + name + ".sp")
		case _:
			print("case not found for num_pes=", num_pes)
			exit(1)

def generate_pim_opencoder_top(name):
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("********************************************************************************\n")
	top_file.write(".LIB \"../includes.l\" INCLUDES\n")
	top_file.write("*.LIB \"./pim_opencoder_coffe.sp\" PIM_OP_ENCODER\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Simulation setup\n")
	top_file.write("********************************************************************************\n")
	top_file.write("* Run for 40 ns with 10 ps resolution\n")
	top_file.write(".TRAN 10p 6n SWEEP DATA=sweep_data\n")
	top_file.write(".OPTIONS BRIEF=1\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Power supplies\n")
	...
	top_file.write("** Input stimulus\n")
	top_file.write("********************************************************************************\n")
	top_file.write("Vx x 0 PULSE(0 supply_v 1n 0 0 2n 4n)\n")
	top_file.write("Vy y 0 supply_v\n")
	top_file.write("VopConfig0 opIn0 0 0\n")
	top_file.write("VopConfig1 opIn1 0 0\n")
	top_file.write("VopConfig2 opIn2 0 supply_v\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Circuit under test\n")
	top_file.write("********************************************************************************\n")
	top_file.write("Xopencoder opIn0 opIn1 opIn2 opOut0 opOut1 x y n_vdd n_gnd opencoder\n")
	top_file.write("*Xdummyinv x inv_out d_vdd d_gnd inv Wn=inv_opencoder_nmos Wp=inv_opencoder_pmos\n")
	top_file.write("*Xdummynand2 x nand2_out d_vdd d_gnd nand2 Wn=nand2_opencoder_nmos Wp=nand2_opencoder_pmos\n")
	top_file.write("*Xdummynand3 x nand3_out d_vdd d_gnd nand3 Wn=nand3_opencoder_nmos Wp=nand3_opencoder_pmos\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Measurements\n")
	top_file.write("********************************************************************************\n")
	top_file.write("*X measurements inv\n")
	top_file.write(".MEASURE TRAN meas_total_trise TRIG V(x) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(opOut1) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1n TO=4n\n")
	top_file.write(".MEASURE TRAN meas_total_tfall TRIG V(x) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(opOut1) VAL='supply_v/2' RISE=1\n")
	top_file.write("\n")
	...
	top_file.write("\n")
	top_file.write("* Logic levels at output\n")
	top_file.write(".MEASURE TRAN meas_logic_low_voltage  FIND V(opOut1) AT=2n\n")
	top_file.write("* .MEASURE TRAN vout_high FIND V(opOut1) AT=4n\n")
	top_file.write("\n")
	top_file.write("* Power consumption\n")
	top_file.write(".MEASURE TRAN i_vdd      INTEGRAL I(VDD) FROM=0n TO=4n\n")
	top_file.write(".MEASURE TRAN meas_avg_power  PARAM = '-(i_vdd/4n)*supply_v'\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("\n")
	top_file.write(".OPTION POST\n")
...
def generate_pim_opencoder2_top(name):
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("********************************************************************************\n")
	top_file.write(".LIB \"../includes.l\" INCLUDES\n")
	top_file.write("* .LIB \"./pim_opEncoder_lite.sp\" PIM_OP_ENCODER\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Simulation setup\n")
	top_file.write("********************************************************************************\n")
	top_file.write("* Run for 40 ns with 10 ps resolution\n")
	top_file.write(".TRAN 10p 4n\n")
	top_file.write(".OPTIONS BRIEF=1\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Power supplies\n")
	...
	top_file.write("*X measurements inv\n")
	top_file.write(".MEASURE TRAN meas_total_trise TRIG V(x) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(opOut0) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1n TO=6n\n")
	top_file.write(".MEASURE TRAN meas_total_tfall TRIG V(x) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(opOut0) VAL='supply_v/2' RISE=1\n")
	top_file.write("\n")
	top_file.write("* Logic levels at output\n")
	top_file.write(".MEASURE TRAN meas_logic_low_voltage  FIND V(opOut0) AT=2n\n")
	top_file.write("* .MEASURE TRAN vout_high FIND V(opOut0) AT=4n\n")
	top_file.write("\n")
	top_file.write("* Power consumption\n")
	top_file.write(".MEASURE TRAN i_vdd      INTEGRAL I(VDD) FROM=0n TO=4n\n")
	top_file.write(".MEASURE TRAN meas_avg_power  PARAM = '-(i_vdd/4n)*supply_v'\n")
	...
	top_file.write(".OPTION POST\n")
	top_file.write("\n")
	top_file.write(".print tran V(x) V(opOut0) V(opOut1)\n")
	top_file.write("\n")
	top_file.write(".END\n")
	top_file.close()
	os.chdir("../")
...
def generate_pim_netnode_top(name):
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("********************************************************************************\n")
	top_file.write(".LIB \"../includes.l\" INCLUDES\n")
	top_file.write("* .LIB \"./networknode_comb.sp\" PIM_NETNODE\n")
	top_file.write("* .param supply_v=0.8V\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Simulation setup\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("\n")
	top_file.write("\n")
	top_file.write("**select signal timing will not matter as select configs will be set a full  \n")
	top_file.write("*clock cycle before net signals are sent\n")
	top_file.write("Vrxsel0 rxsel0 0 0\n")
	top_file.write("Vrxsel0n rxsel0n 0 supply_v\n")
	top_file.write("Vrxsel1 rxsel1 0 0\n")
	top_file.write("Vrxsel1n rxsel1n 0 supply_v\n")
	top_file.write("\n")
	top_file.write("*rf_in to\n")
	top_file.write("* Vtxsel0 txsel0 0 0\n")
	top_file.write("* Vtxsel0n txsel0n 0 supply_v\n")
	top_file.write("* Vtxsel1 txsel1 0 0\n")
	top_file.write("* Vtxsel1n txsel1n 0 supply_v\n")
	top_file.write("\n")
	top_file.write("*Rx to tx\n")
	top_file.write("Vtxsel0 txsel0 0 0\n")
	top_file.write("Vtxsel0n txsel0n 0 supply_v\n")
	top_file.write("Vtxsel1 txsel1 0 supply_v\n")
	top_file.write("Vtxsel1n txsel1n 0 0\n")
	top_file.write("\n")
	top_file.write("*Dff to tx\n")
	top_file.write("* Vtxsel0 txsel0 0 supply_v\n")
	top_file.write("* Vtxsel0n txsel0n 0 0\n")
	top_file.write("* Vtxsel1 txsel1 0 0\n")
	top_file.write("* Vtxsel1n txsel1n 0 supply_v\n")
	top_file.write("\n")
	top_file.write("*Network in signals\n")
	top_file.write("Vn n 0 PULSE(0 supply_v 1n 0 0 2n 4n)\n")
	top_file.write("Ve e 0 0\n")
	top_file.write("Vw w 0 0\n")
	top_file.write("Vs s 0 0\n")
	top_file.write("*dff in signal\n")
	top_file.write("* Vcapout cap_out 0 0\n")
	top_file.write("Vcapout cap_in 0 0\n")
	top_file.write("*register-file in signal\n")
	top_file.write("Vrf rf_in 0 0\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Circuit under test\n")
	top_file.write("********************************************************************************\n")
	top_file.write("XNetNode rf_in cap_in\n")
	top_file.write("+n e w s\n")
	top_file.write("+rxsel0 rxsel0n rxsel1 rxsel1n \n")
	top_file.write("+txsel0 txsel0n txsel1 txsel1n \n")
	top_file.write("+to_cap news_out\n")
	top_file.write("+n_vdd n_gnd NetNode\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Measurements\n")
	top_file.write("********************************************************************************\n")
	top_file.write(".MEASURE TRAN meas_total_trise TRIG V(n) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(news_out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN meas_total_tfall TRIG V(n) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(news_out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	top_file.write("\n")
	top_file.write("\n")
	top_file.write("* Logic levels at output\n")
	top_file.write(".MEASURE TRAN meas_logic_low_voltage  FIND V(news_out) AT=5n\n")
	top_file.write("* .MEASURE TRAN vout_high FIND V(news_out) AT=4n\n")
	top_file.write("\n")
	top_file.write("* Power consumption\n")
	...
	top_file.write("********************************************************************************\n")
	top_file.write("\n")
	top_file.write("* .print tran V(out)\n")
	top_file.write("\n")
	top_file.write(".OPTION POST\n")
	top_file.write("\n")
	top_file.write(".END\n")
...
def generate_pim_dff_top(name): #Used solely for power
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("*--------------------------------------------------------------\n")
	top_file.write("* Testbench for PIM DFF\n")
	top_file.write("*--------------------------------------------------------------\n")
	top_file.write(".TITLE PIM dff testbench\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Include libraries, parameters, and device models\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("********************************************************************************\n")
	top_file.write("* Run for 40 ns with 10 ps resolution\n")
	top_file.write(".param setup_time = 0n\n")
	top_file.write(".TRAN 10p 8n SWEEP DATA=sweep_data\n")
	top_file.write("* .TRAN 0.1p 8n SWEEP setup_time 0.008n 0.010n .0001n\n")
	top_file.write(".OPTIONS BRIEF=1\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Power supplies\n")
	...
	top_file.write("** Input stimulus\n")
	top_file.write("********************************************************************************\n")
	top_file.write("Vclk clk 0 PULSE(0 supply_v 1n 0 0 1n 2n)\n")
	top_file.write("Vd d 0 PULSE(0 supply_v 2.5n 0 0 4n 6n)\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Circuit under test\n")
	top_file.write("********************************************************************************\n")
	top_file.write("xdff clk d q qn n_vdd n_gnd PIM_DFF\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Measurements\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("\n")
	top_file.write("* Logic levels at output\n")
	# top_file.write("* .print(setup_time)\n")
	# top_file.write("* .MEASURE TRAN vout_low  FIND V(q) AT=8n \n")
	# top_file.write("* .MEASURE TRAN vout_high FIND V(q) AT=4n\n")
	# top_file.write("* .MEASURE TRAN pass_low PARAM='vout_low < 0.2'\n")
	# top_file.write("* .MEASURE TRAN pass_high PARAM='vout_high > 0.6'\n")
	top_file.write(".MEASURE TRAN meas_logic_low  FIND V(q) AT=8n \n")
	top_file.write("\n")
	top_file.write("* Power consumption\n")
	top_file.write(".MEASURE TRAN i_vdd      INTEGRAL I(VDD) FROM=0n TO=8n\n")
	top_file.write(".MEASURE TRAN meas_avg_power  PARAM = '-(i_vdd/8n)*supply_v'\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("\n")
	top_file.write("\n")
...
def generate_pim_dff_lp_top(name): #Used solely for power
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("*--------------------------------------------------------------\n")
	top_file.write("* Testbench for PIM DFF LP\n")
	top_file.write("*--------------------------------------------------------------\n")
	top_file.write(".TITLE OpEncoder Unit Testbench\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("** Circuit under test\n")
	top_file.write("********************************************************************************\n")
	top_file.write("xdff clk d q qn n_vdd n_gnd PIM_DFF_LP\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Measurements\n")
	top_file.write("********************************************************************************\n")
...
def generate_pim_dff_le_top(name): #Used solely for power
	# Create directories
	if not os.path.exists(name):
		os.makedirs(name)
	# Change to directory
	...
	top_file.write("********************************************************************************\n")
	top_file.write(".LIB \"../includes.l\" INCLUDES\n")
	# top_file.write(".LIB \"./dff_rst_en.sp\" DFF_RST_EN\n")
	top_file.write("* .param supply_v=0.8V\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Simulation setup\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("Vclk clk 0 PULSE(0 supply_v 1n 0 0 1n 2n)\n")
	top_file.write("Vd d 0 PULSE(0 supply_v 2.5n 0 0 4n 6n)\n")
	top_file.write("Vrst rst 0 0\n")
	top_file.write("*En will be on half/the time in this sim. Will be off >half the time in reality.\n")
	top_file.write("Ven en 0 PULSE(0 supply_v 1n 0 0 4n 8n) \n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Circuit under test\n")
	top_file.write("********************************************************************************\n")
	top_file.write("xdffle clk d rst en q n_vdd n_gnd pim_dff_le\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("** Measurements\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("* +     TARG V(opnY_1) VAL='supply_v/2' RISE=1\n")
	top_file.write("* +     FROM=1n TO=6n\n")
	top_file.write("* .MEASURE TRAN tpd_fall TRIG V(A2) VAL='supply_v/2' FALL=1\n")
	top_file.write("* +     TARG V(opnY_1) VAL='supply_v/2' FALL=1\n")
	top_file.write("\n")
	top_file.write("* Logic levels at output\n")
	top_file.write("* .print(setup_time)\n")
	top_file.write("* .MEASURE TRAN vout_low  FIND V(q) AT=8n \n")
	...
	top_file.write("* .MEASURE TRAN pass_high PARAM='vout_high > 0.6'\n")
	top_file.write(".MEASURE TRAN meas_logic_low  FIND V(q) AT=8n \n")
	top_file.write(".MEASURE TRAN meas_logic_high  FIND V(q) AT=4n \n")
	top_file.write("\n")
	top_file.write("\n")
	top_file.write("* Power consumption\n")
	top_file.write(".MEASURE TRAN i_vdd      INTEGRAL I(VDD) FROM=0n TO=8n\n")
	...
	top_file.write("********************************************************************************\n")
	top_file.write("\n")
	top_file.write(".print tran V(clk) V(d) V(q) V(qn)\n")
	top_file.write("\n")
	top_file.write(".OPTION POST\n")
	top_file.write("\n")
	top_file.write(".END\n")
