...
def generate_boothr2adder_top(name):
	...
	top_file.write("XtimingDummyInv cin inv_out n_vdd n_gnd inv Wn=inv_BoothR2Adder_nmos Wp=inv_BoothR2Adder_pmos\n")
	top_file.write("XtimingDummyNand2 cin cin nand2_out n_vdd n_gnd nand2_decode Wn=nand2_BoothR2Adder_nmos Wp=nand2_BoothR2Adder_pmos\n")
	top_file.write("XtimingDummyNand3 cin cin cin nand3_out n_vdd n_gnd nand3_decode Wn=nand3_BoothR2Adder_nmos Wp=nand3_BoothR2Adder_pmos\n")
	top_file.write("XtimingDummyNor2 cin cin nor2_out n_vdd n_gnd nor2_decode Wn=nor2_BoothR2Adder_nmos Wp=nor2_BoothR2Adder_pmos\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	...
	top_file.write("\n")
	top_file.write("*Y measurements\n")
	top_file.write("* .MEASURE TRAN tpd_rise_yo TRIG V(y) VAL='supply_v/2' RISE=1\n")
	top_file.write("* +     TARG V(out) VAL='supply_v/2' RISE=1\n")
	top_file.write("* +     FROM=1n TO=6n\n")
	top_file.write("* .MEASURE TRAN tpd_fall_yo TRIG V(y) VAL='supply_v/2' FALL=1\n")
	top_file.write("* +     TARG V(out) VAL='supply_v/2' FALL=1\n")
	top_file.write("\n")
	top_file.write("* .MEASURE TRAN tpd_rise_yc TRIG V(y) VAL='supply_v/2' RISE=1\n")
	top_file.write("* +     TARG V(cout) VAL='supply_v/2' RISE=1\n")
	top_file.write("* +     FROM=1n TO=6n\n")
	top_file.write("* .MEASURE TRAN tpd_fall_yc TRIG V(y) VAL='supply_v/2' FALL=1\n")
	top_file.write("* +     TARG V(cout) VAL='supply_v/2' FALL=1\n")
	top_file.write("\n")
	...
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#measure an inverter rise and fall time
	...
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#measure an nand2 rise and fall time
	#	spice_file.write('XU51 cb_in n4 n_vdd n_gnd inv')
	top_file.write("\n")
	...
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#measure nand3 rise and fall time
	top_file.write("\n")
	...
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	#measure nor2 rise and fall time
	top_file.write("\n")
