...
def generate_boothr2adder_top(name):
	...
	top_file.write(".MEASURE TRAN tpd_rise TRIG V(cin) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write(".MEASURE TRAN tpd_fall TRIG V(cin) VAL='supply_v/2' RISE=1\n")
	top_file.write("+     TARG V(out) VAL='supply_v/2' FALL=1\n")
	top_file.write("+     FROM=1ns TO=6ns\n")
	top_file.write("\n")
	...
	top_file.write(".MEASURE TRAN avg_power  PARAM = '-(i_vdd/6n)*supply_v'\n")
	top_file.write("\n")
	top_file.write("********************************************************************************\n")
	top_file.write("\n")
